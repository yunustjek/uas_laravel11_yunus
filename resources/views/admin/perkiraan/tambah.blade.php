...
<div class="mb-3">
  ...
  <input type="text" class="form-control" name="NomorPerkiraan" id="exampleFormControlInput1" placeholder="Nomor Perkiaan">
</div>

<div class="mb-3">
  <label for="exampleFormControlTextarea1" class="form-label">Nama Perkiraan</label>
  <input type="text" class="form-control" name="NamaPerkiraan" id="exampleFormControlInput1" placeholder="Nama Perkiraan">
</div>
